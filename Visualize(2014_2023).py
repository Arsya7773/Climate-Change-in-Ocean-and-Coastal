...
axes[0].set_title('Average SST for 2014-2023 (Whole Indonesia)')
axes[0].set_xlabel('Longitude')
axes[0].set_ylabel('Latitude')

# Plot the second map with latitude and longitude slicing
im2 = sst_2014_2023.plot(ax=axes[1], cmap='coolwarm', vmin=25, vmax=30)
axes[1].set_title('Average SST for 2014-2023 (Kepulauan Sunda Kecil)')
