...
sst_1994_2003 = ds['sst'].sel(
    time=slice('1994-01-01', '2003-12-31'), 
...
axes[0].set_title('Average SST for 1994-2003 (Whole Indonesia)')
axes[0].set_xlabel('Longitude')
axes[0].set_ylabel('Latitude')

# Plot the second map with latitude and longitude slicing
im2 = sst_1994_2003.plot(ax=axes[1], cmap='coolwarm', vmin=25, vmax=30)
axes[1].set_title('Average SST for 1994-2003 (Kepulauan Sunda Kecil)')
