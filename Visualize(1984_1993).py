...
sst_1984_1993 = ds['sst'].sel(
    time=slice('1984-01-01', '1993-12-31'), 
...
axes[0].set_title('Average SST for 1984-1993 (Whole Indonesia)')
axes[0].set_xlabel('Longitude')
axes[0].set_ylabel('Latitude')

# Plot the second map with latitude and longitude slicing
im2 = sst_1984_1993.plot(ax=axes[1], cmap='coolwarm', vmin=25, vmax=30)
axes[1].set_title('Average SST for 1984-1993 (Kepulauan Sunda Kecil)')
